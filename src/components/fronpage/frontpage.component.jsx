...
export function Frontpage() {
    ...
    const filterData = (query) => {
        const filtered = restData.filter(item =>
            item.restarent_name.toLowerCase().includes(query.toLowerCase())
        );
    ...
    return (
        <div className='main-back'>
            ...
            <div className='back'>
                ...
                <h1 className='q'> Expect the best, plan for the worst, and prepare to be surprised</h1>  <br></br>
                    ...
                    <div className='search'>
                        ...
                        <ul className='max'>
                            {filteredData.map((item, index) => (
                                <a href='/aha'> <li key={index} className='like'>{item.restarent_name}</li></a>
                            ))}
                        </ul>
